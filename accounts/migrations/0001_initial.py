    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('readonly', 'Patron'), ('product_manager', 'Proje Müdürü'), ('plant_manager', 'Ekim Sorumlusu'), ('plant_personel', 'Ekim Personeli'), ('seed_manager', 'Aşı Sorumlusu'), ('seed_personel', 'Aşı Personeli'), ('finance_personel', 'Finans Personeli'), ('shipping_personel', 'Sevkiyat Personeli')], max_length=20)),
                ('phone_number', models.CharField(max_length=10)),
                ('pin_code', models.CharField(db_index=True, max_length=4, unique=True)),
